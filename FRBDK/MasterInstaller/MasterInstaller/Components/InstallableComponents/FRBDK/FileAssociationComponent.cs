...
{
    public class FileAssociationComponent : ComponentBase
    {
        #region Properties
        ...
        {
            get { return ComponentStorage.CompletedComponent; }
        }

        #endregion

        public FileAssociationComponent()
        {
            this.Control = new FileAssociationControl();
        }

        public override bool MovingNextFromComponent()
        {
            if (((FileAssociationControl)Control).ShouldInstall)
            {
        ...
        private void SetAllFileAssociations()
        {
            // Set up file associations
            string frbdkFolder = ComponentStorage.GetValue<string>(FrbdkSetupComponent.Path);
        ...
        void Associate(string extension,
