...
namespace GlueViewOfficialPlugins.States
{
    ...
    public partial class StateCategoryControl : UserControl
    {
        ...
        public string FirstInterpolatedStateName
        {
            get
            {
                if (InterpolateFromComboBox.Text.Contains(' '))
                {
                    return InterpolateFromComboBox.Text.Substring(0, InterpolateFromComboBox.Text.IndexOf(' '));
                }
                else
                {
                    return null;
        ...
        public string SecondInterpolatedStateName
        {
            get
            {
                if (InterpolateToComboBox.Text.Contains(' '))
                {
                    return InterpolateToComboBox.Text.Substring(0, InterpolateToComboBox.Text.IndexOf(' '));
                }
                else
                {
                    return null;
