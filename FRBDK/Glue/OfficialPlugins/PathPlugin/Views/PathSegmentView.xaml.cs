...
namespace OfficialPlugins.PathPlugin.Views
{
    ...
    public partial class PathSegmentView : UserControl
    {
        ...
        readonly LabelDragScrubber angleDragScrubber;
        ...
        public PathSegmentView()
        {
            ...
            xDragScrubber = new LabelDragScrubber(XLabel, this, () => ViewModel?.X ?? 0, v => { if (ViewModel != null) ViewModel.X = v; });
            yDragScrubber = new LabelDragScrubber(YLabel, this, () => ViewModel?.Y ?? 0, v => { if (ViewModel != null) ViewModel.Y = v; });
            angleDragScrubber = new LabelDragScrubber(AngleLabel, this, () => ViewModel?.Angle ?? 0, v => { if (ViewModel != null) ViewModel.Angle = v; });
        }
