...
public class TileShapeCollectionsPropertiesController
{
    ...
    public TileShapeCollectionsPropertiesController(AssetTypeInfoAdder assetTypeInfoAdder)
    {
    ...
    public Views.TileShapeCollectionProperties GetView()
    {
        if(view == null)
        {
            view = new Views.TileShapeCollectionProperties(this);
    ...
    public bool IsTileShapeCollection(NamedObjectSave namedObject)
    {
        ...
        if (namedObject != null)
        {
            ...
            isTileShapeCollection =
                        ati == _assetTypeInfoAdder.TileShapeCollectionAssetTypeInfo;
        }
    ...
    public IEnumerable<NamedObjectSave> GetTmxNamedObjectsIn(IElement element)
    {
        return element.AllNamedObjects
            .Where(item =>
                item.IsDisabled == false &&
                item.GetAssetTypeInfo() == _assetTypeInfoAdder.TmxAssetTypeInfo);
    }

    public IEnumerable<ReferencedFileSave> GetTmxFilesIn(IElement element)
    {
