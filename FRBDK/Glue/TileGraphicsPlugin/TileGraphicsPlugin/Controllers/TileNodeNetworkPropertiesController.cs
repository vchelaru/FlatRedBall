...
public class TileNodeNetworkPropertiesController
{
    ...
    public TileNodeNetworkPropertiesController(AssetTypeInfoAdder assetTypeInfoAdder,
    ...
    public bool IsTileNodeNetwork(NamedObjectSave namedObject)
    {
        ...
        if (namedObject != null)
        {
            ...
            isTileNodeNetwork =
                        ati == _assetTypeInfoAdder.TileNodeNetworkAssetTypeInfo;
        }
    ...
    private void RefreshAvailableTiledObjects(IElement element)
    {
        ...
        IEnumerable<ReferencedFileSave> referencedFileSaves = _tileShapeCollectionsPropertiesController.GetTmxFilesIn(element);

        IEnumerable<NamedObjectSave> namedObjects = _tileShapeCollectionsPropertiesController.GetTmxNamedObjectsIn(element);
