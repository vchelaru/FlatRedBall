...
namespace PluginTestbed.SceneProgramChooser
{
    ...
    public partial class SceneProgramChooserPlugin : ITreeViewRightClick
	{
        ...
        public void OnOpenWithSpriteEditorClick(object sender, EventArgs e)
        {
            GlueCommands.OpenCommands.OpenWithSpriteEditor(FileManager.RelativeDirectory + EditorLogic.CurrentReferencedFile.Name);
        }

        public void OnOpenWithTileEditorClick(object sender, EventArgs e)
        {
            GlueCommands.OpenCommands.OpenWithTileEditor(FileManager.RelativeDirectory + EditorLogic.CurrentReferencedFile.Name);
        }
	}
}
