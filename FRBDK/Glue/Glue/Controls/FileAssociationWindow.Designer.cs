...
partial class FileAssociationWindow
{
    ...
    private void InitializeComponent()
    {
        ...
        this.MakeRelativeToProjectButton.Text = $"{L.Texts.MakeRelative} (..\\..\\program.exe)";
        ...
        this.MakeAbsoluteButton.Text = $"{L.Texts.MakeAbsolute} (c:\\program.exe)";
        ...
        this.label1.Text = L.Texts.SelectedFileAssociation;
        // 
        // panel1
        // 
        ...
        this.Text = L.Texts.FileAssociations;
