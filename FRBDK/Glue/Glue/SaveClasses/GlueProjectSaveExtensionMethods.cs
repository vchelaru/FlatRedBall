...
/// <summary>
/// What's left after #2276 moved the project-wide fix-ups that only need GlueCommon (RemoveInvalidStatesFromNamedObjects,
/// PostLoadInitialize, FixAllTypesPostLoad, FixEnumerationValues, ConvertEnumerationValuesToInts, AllElements,
/// FixReferencedFileSaveContentPipelineSettings, SearchForDuplicateNamedObjects, SearchForDuplicateEntities,
/// CleanUnusedVariablesFromStates, FixAttachmentProperties) to <see cref="GlueProjectSaveCommonExtensions"/>.
/// Everything here still reaches GlueCommands, GlueState, PluginManager, InheritanceManager or ObjectFinder directly.
/// </summary>
