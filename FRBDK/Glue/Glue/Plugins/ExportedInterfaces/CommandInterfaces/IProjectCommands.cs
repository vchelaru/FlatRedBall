...
namespace FlatRedBall.Glue.Plugins.ExportedInterfaces.CommandInterfaces
{
    ...
    {
        /// <summary>
        /// Saves the main project and synced projects (csproj) immediately if run from an existing task. Adds a task if not.
        /// </summary>
        void SaveProjects();
        ...
        /// <returns></returns>
        bool UpdateFileMembershipInProject(VisualStudioProject project, FilePath fileName, bool useContentPipeline, bool shouldLink,
