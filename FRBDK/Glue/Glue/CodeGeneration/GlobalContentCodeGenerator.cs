...
namespace FlatRedBall.Glue.Parsing
{
    ...
    public static class GlobalContentCodeGenerator
    {
        ...
        private static ICodeBlock GetLoadGlobalContentCode()
        {
            ...
            #region Instantiate the ClassProperties instance used to generate GlobalContent
        ...
        private static ICodeBlock GetGlobalContentFilesMethods()
        {
            ...
            #region Add Fields and Properties for each global file
            ...
            ICodeBlock initializeFunction;
            bool loadAsync;
            currentBlock = GenerateInitializeMethod(currentBlock, classLevelBlock, out initializeFunction, out loadAsync);
        ...
        private static ICodeBlock GenerateInitializeMethod(ICodeBlock currentBlock, ICodeBlock classLevelBlock, out ICodeBlock initializeFunction, out bool loadAsync)
        {
            ...
            loadAsync = GenerateLoadAsyncCode(classLevelBlock, initializeFunction);
            return currentBlock;
        }
