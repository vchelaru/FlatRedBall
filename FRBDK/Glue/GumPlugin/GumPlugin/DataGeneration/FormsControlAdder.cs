...
public static class FormsControlAdder
{
    ...
    private static void AddElementsToResourceFileDestinations(FilePath componentDestination, Dictionary<string, FilePath> resourceToFileDestinations,
        string[] resourcesInAssembly, string defaultFormsPrefix, string extensionWithDot)
    {
