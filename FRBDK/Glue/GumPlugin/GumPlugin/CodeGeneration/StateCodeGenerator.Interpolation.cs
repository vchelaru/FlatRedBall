...
public partial class StateCodeGenerator
{
        ...
        string enumType, IEnumerable<StateSave> states, StateSaveCategory category)
    {
        ...
        //if (states.Count() > 0)
        {
            ...
            {
                fieldToAssign = "mCurrent" + category.Name + "State";
            }
    ...
    private void GenerateStateInterpolateBetween(ElementSave elementSave, ICodeBlock currentBlock)
    {
        ...
        {
            enumType = category.EnumNameInCode();
    ...
    private void GenerateStateInterpolateTo(ElementSave elementSave, ICodeBlock currentBlock)
    {
        ...
        GenerateInterpolateToFromCurrent(currentBlock, enumType, isRelative: false, category:null);
        GenerateInterpolateToFromCurrent(currentBlock, enumType, isRelative: true, category: null);
        ...
        foreach (var category in elementSave.Categories)
        {
            ...
            states = category.States;
            GenerateInterpolateTo(elementSave, currentBlock, states, enumType);
            GenerateInterpolateToFromCurrent(currentBlock, enumType, isRelative: false, category: category);
            GenerateInterpolateToFromCurrent(currentBlock, enumType, isRelative: true, category: category);
        }
    ...
    private void GenerateInterpolateToFromCurrent(ICodeBlock currentBlock, string enumType, bool isRelative, StateSaveCategory category)
    {
        ...
        {
            var effectiveName = category?.Name ?? enumType;
            variableName = $"Current{effectiveName}State";
        }
