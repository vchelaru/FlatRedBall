...
namespace GameCommunicationPlugin.GlueControl.Dtos
{
    ...
    /// SelectionMarker.SimulateResizeDragForTesting (Embedded) - applies one resize-drag step of
    /// (WorldXChange, WorldYChange), as if Side's handle had been dragged that far in world units. See #2087.
    /// </summary>
