...
public class TextureContentLoader : IContentLoader<Texture2D>
{
    ...
    /// <summary>
    /// Controls whether MipMaps are created when loading textures. If true, then mipmaps are created. Mipmaps can increase
    /// memory usage, but can be helpful when rendering textures at smaller sizes, especially important for 3D rendering.
    /// For 2D games this can be set to false to save memory. Also, UI should usually not be rendered with mipmaps.
    /// </summary>
