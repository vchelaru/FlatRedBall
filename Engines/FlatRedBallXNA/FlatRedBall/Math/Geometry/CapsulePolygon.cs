...
namespace FlatRedBall.Math.Geometry
{
    public class CapsulePolygon : Polygon
    {
        ...
        void RecalculatePoints()
        {
            ...
            Point[] points = new Point[semicircleNumberOfPoints * 2 + 5];
            ...
            points[0] = new Point(ref r1);
            points[1] = new Point(ref r2);
            ...
            for (int i = 0; i < semicircleNumberOfPoints; i++)
            {
                ...
                points[lastPointInserted + i + 1] = new Point(ref finalPosition);
            }

            // Add second straight points
            lastPointInserted = 1 + semicircleNumberOfPoints;
            points[lastPointInserted + 1] = new Point(ref r3);
            points[lastPointInserted + 2] = new Point(ref r4);
            lastPointInserted += 2;
            ...
            // Add closing point
            points[lastPointInserted + 1] = new Point(ref r1);
