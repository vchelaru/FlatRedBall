...
public partial class StateScreen
{
    ...
    void CustomInitialize()
    {
        ...
        StateEntityChildInstanceBaseDerivedStates.CurrentCategoryDefinedInBaseState = StateEntityChild.CategoryDefinedInBase.DerivedFirst;
        StateEntityChildInstanceBaseDerivedStates.VariableSetInBothBaseAndDerivedEntity.ShouldBe(3);
        StateEntityChildInstanceBaseDerivedStates.CurrentCategoryDefinedInBaseState = StateEntityChild.CategoryDefinedInBase.DerivedSecond;
        StateEntityChildInstanceBaseDerivedStates.VariableSetInBothBaseAndDerivedEntity.ShouldBe(4);
        StateEntityChildInstanceBaseDerivedStates.CurrentCategoryDefinedInBaseState = StateEntityChild.CategoryDefinedInBase.FirstState;
        StateEntityChildInstanceBaseDerivedStates.VariableSetInBothBaseAndDerivedEntity.ShouldBe(1);
