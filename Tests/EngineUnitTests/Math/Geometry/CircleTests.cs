...
public class CircleTests
{
    ...
    [Fact]
    public void CollideAgainstBounce_ShouldInvertVelocity_WithAcceleration()
    {
        var circle = new Circle();
        circle.Radius = 10;
        circle.X = -10 + .01f;
        circle.XVelocity = 10;
        circle.XAcceleration = 1;
        ...
        TimeManager.Update(
            new Microsoft.Xna.Framework.GameTime(
                TimeSpan.Zero, TimeSpan.FromSeconds(secondDifference)));


        circle.CollideAgainstBounce(rectangle, 0, 1, 1);

        circle.XVelocity.ShouldBeInRange(-10, -9.9f, "because collision should bounce this");
    }
    ...
    [Fact]
    public void CollideAgainstBounce_ShouldNotOverAssignYVelocity_WithAccelerationAndDrag()
    {
        var circle = new Circle();
        circle.Radius = 10;
        circle.Y = 10f;
