...
{
	public partial class FlatRedBallTypeEntity
	{
		private void CustomInitialize()
		{
            this.OffsetScene.Sprites[0].ForceUpdateDependencies();
            this.OffsetScene.Sprites[1].ForceUpdateDependencies();
            if (this.OffsetScene.Sprites[0].X != this.OffsetScene.Sprites[1].X)
            {
