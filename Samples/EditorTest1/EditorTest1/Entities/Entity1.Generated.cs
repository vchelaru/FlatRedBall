...
using System.Text;
namespace EditorTest1.Entities
{
    public partial class Entity1 : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Entities.IEntity, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public string EditModeType { get; set; } = "EditorTest1.Entities.Entity1";
        protected FlatRedBall.Graphics.Layer LayerProvidedByContainer = null;
        public Entity1 () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public Entity1 (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Entity1 (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            {
                throw new System.Exception( "Entity1 has been loaded with a Global content manager, then loaded with a non-global.  This can lead to a lot of bugs");
            }
            #endif
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Entity1StaticUnload", UnloadStaticContent);
