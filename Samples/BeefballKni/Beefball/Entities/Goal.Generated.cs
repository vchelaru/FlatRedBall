...
{
    public partial class Goal : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Entities.IEntity, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Goal (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Goal (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void PostInitialize () 
        {
            ...
            AxisAlignedRectangleInstance.Height = 200f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            {
                throw new System.Exception( "Goal has been loaded with a Global content manager, then loaded with a non-global.  This can lead to a lot of bugs");
            }
            #endif
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("GoalStaticUnload", UnloadStaticContent);
